  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4">
      <div className="text-center">
        <h1 className="text-6xl font-extrabold text-primary-light dark:text-primary-dark mb-4">
          404
        </h1>
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          Maaf, halaman yang Anda cari tidak ada. Mungkin URL salah atau halaman
          sudah dihapus.
        </p>
        <Link
          to="/"
